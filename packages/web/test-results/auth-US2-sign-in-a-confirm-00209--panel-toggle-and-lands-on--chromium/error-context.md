...
- Name: auth.spec.ts >> US2: sign in >> a confirmed user signs in via the panel toggle and lands on /
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e12]:
        - generic [ref=e13]:
          ...
          - textbox "Email" [ref=e15]: e2e-signin-1782776976089-ed867f@example.com
        - generic [ref=e16]:

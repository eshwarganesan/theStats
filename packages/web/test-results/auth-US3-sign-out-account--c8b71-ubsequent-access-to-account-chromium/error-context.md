...
- Name: auth.spec.ts >> US3: sign out + account-gate >> sign-out reverts the app to anonymous mode and blocks subsequent access to /account
- Location: tests/e2e/auth.spec.ts:196:7
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e12]:
        - generic [ref=e13]:
          ...
          - textbox "Email" [ref=e15]: e2e-signout-1780785593328-apfki3@example.com
        - generic [ref=e16]:
